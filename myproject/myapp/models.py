...
class Tovar(models.Model):
  ...
  articul = models.CharField(max_length=300, unique=True, verbose_name='Артикул')
  edinicaIzmerenia = models.CharField(max_length=300, verbose_name='Единица измерения')
...
class Zakaz(models.Model):
  ...
  codPoluchenia = models.IntegerField(max_digits=3 ,default=sluchainyi_cod())
